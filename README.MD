...
implementation 'com.saltedge.sdk:saltedge-library:1.3.8@aar'
```
...
implementation 'com.squareup.okhttp3:logging-interceptor:3.13.1'//Network communication logging
```
